...
- To contact CZ: mentions=["cz"]

The senderId contains the user's actual wallet address for scoring.
Use it directly in award_points(senderId, points, reason, category, subcategory, "melania-trump")

EXAMPLE WORKFLOW:
1. score_result = award_points("6pF45ayW...", 5, "Good attempt", "negotiation", "medium_quality", "melania-trump")
