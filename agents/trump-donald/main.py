...
Use it directly in award_points(senderId, points, reason, category, subcategory, "donald-trump")

EXAMPLE WORKFLOW:
1. score_result = award_points("6pF45ayW...", 5, "Good attempt", "negotiation", "medium_quality", "donald-trump")
